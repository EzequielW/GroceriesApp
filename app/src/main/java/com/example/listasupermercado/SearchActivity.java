...
public class SearchActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        ArrayList<Product> protein = new ArrayList<Product>();
        ...
        ArrayList<Product> grains = new ArrayList<Product>();
        ...
        ArrayList<Product> cleaning = new ArrayList<Product>();
        ...
        ArrayList<Product> seasoning = new ArrayList<Product>();
